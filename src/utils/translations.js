export const translations = {
  en: {
    ...
    buildingDigital: "Building Digital",
    ...
    database: "Database",
    devops: "DevOps",
    frontendDesc: "Crafting beautiful, responsive user interfaces.",
    backendDesc: "Building robust server-side solutions",
    databaseDesc: "Designing and implementing efficient databases",
    devopsDesc: "Ensuring smooth deployment and scaling",
    ...
    myStatsPassions: "My Stats & Passions",
    ...
    ecommerceOutreach: "E-Commerce Application Outreach",
    ecommerceDesc:
    ...
    // Passions
    innovationTitle: "Innovation & Problem Solving",
    innovationDesc:
    ...
    inventoryTitle: "Inventory Management System",
    inventoryDesc:
  ...
  id: {
    ...
    buildingDigital: "Membangun Pengalaman",
    experiences: "Digital",
    ...
    innovationDesc:
      "Bersemangat dalam menemukan solusi kreatif untuk tantangan kompleks dan membangun produk yang berdampak.",
    continuousTitle: "Pembelajaran Berkelanjutan",
    continuousDesc:
