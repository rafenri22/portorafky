import {
  ...
  export const PROJECT = [
    ...
    {
      id: 2,
      title: "Employee Data and Payroll Application",
      description: "A web-based application for managing employee records and payroll using Java Servlets and JSP.",
      image: PROJECT_IMG_5,
      tags: ["Java Servlets", "JSP", "MySQL"],
      liveUrl: "#",
      githubUrl: "https://github.com/rafenri22/Aplikasi-Gaji-Karyawan-Netbeans",
      featured: false,
      category: "Java",
    },
    {
      ...
      description: "A Flutter-based mobile app to manage buses, employees, and routes for a transportation company.",
      image: PROJECT_IMG_3,
    ...
    },
    {
      ...
      description: "An e-commerce website for ordering personalized hats with custom designs, built with a modern tech stack.",
      image: PROJECT_IMG_4,
    ...
    },
    {
      ...
      description: "An Android application built with Java for performing real-time stock opname and inventory tracking in warehouses or retail environments.",
      image: PROJECT_IMG_6,
